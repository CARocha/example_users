...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { account: @announcement.account, content: @announcement.content, date: @announcement.date } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { account: @announcement.account, content: @announcement.content, date: @announcement.date } }
